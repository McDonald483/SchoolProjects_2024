...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        /*
         * Uses key hashcode mod table size to find the right bucket, then adds
         * the pair.
         */
    ...
    public final Pair<K, V> remove(K key) {
        ...
        /*
         * Uses key hashcode mod table size to find the right bucket, then
         * removes the pair.
         */
    ...
    public final Pair<K, V> removeAny() {
        ...
        /*
         * Loops through buckets until one is found which isn't empty and
        ...
        while (pair == null) {
            if (this.hashTable[index].size() > 0) {
                pair = this.hashTable[index].removeAny();
            }
            index++;
        }
    ...
    public final V value(K key) {
        ...
        /*
         * Uses key hashcode mod table size to find the right bucket, then
         * returns the pair corresponding to the key.
         */
        return this.hashTable[mod(key.hashCode(), this.hashTable.length)]
                .value(key);
    }
