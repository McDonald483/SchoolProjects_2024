...
public abstract class ListTest {
    ...
    @Test
    public final void testRetreatToStart() {
        /*
         * Set up variables
         */
         ...
         * Evaluate the correctness of the result
         */
        String data1 = list1.removeRightFront();
        String data2 = list2.removeRightFront();

        // check if next nodes are the same
        assertEquals(data2, data1);

        list1.addRightFront(data1);
        list2.addRightFront(data1);

        assertEquals(list2.leftLength(), list1.leftLength());
        assertEquals(list2, list1);
    }

    @Test
    public final void testRetreatAtEnd() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void testRetreatAtEndToStart() {
        /*
         * Set up variables
         */
