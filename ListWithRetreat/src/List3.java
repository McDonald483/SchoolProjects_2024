...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        //create both dummy nodes and link them two eachother
    ...
    public final void addRightFront(T x) {
        ...
        //create a new node object to fill
        Node newNode = new Node();

        //plug x in for new node data to store x in new node
        newNode.data = x;

        //the next is now pointing to whatever top was pointing to
        newNode.next = this.lastLeft.next;

        //link the previous to the last left node
        newNode.previous = this.lastLeft;

        //link the previous right front to newNode
        newNode.next.previous = newNode;

        //link lastLeft next to new node
    ...
    public final T removeRightFront() {
        ...
        //new node is a reference to the node right of last left
        Node removed = this.lastLeft.next;

        //link the last left next reference to the
        this.lastLeft.next = removed.next;

        //link this last left to the node to the right of the removed node
    ...
    public final void advance() {
        ...
        //link lastLeft to the next node
        this.lastLeft = this.lastLeft.next;

        //increment leftLength
        this.leftLength++;
    ...
    public final void moveToStart() {
        ...
        //link lastLeft to the dummy node at the beginning
        this.lastLeft = this.preStart;

        //make rightLength the whole length and set leftLength to zero
    ...
    public final void moveToFinish() {
        //link lastLeft to the last node
        this.lastLeft = this.postFinish.previous;

        //make leftLength the whole length
        this.leftLength += this.rightLength;

        //set rightLength to zero
        this.rightLength = 0;
    ...
    public final void retreat() {
        ...
        //link lastLeft to the node that is left of it
        this.lastLeft = this.lastLeft.previous;

        //decrement leftLength to reflect the change
        this.leftLength--;

        //increment rightLength to reflect the change
        this.rightLength++;
